...
/**
 * NestedScrollViewCopy is just like {@link ScrollView}, but it supports acting
 * as both a nested scrolling parent and child on both new and old versions of Android.
 * Nested scrolling is enabled by default.
 */
public class NestedScrollViewCopy extends FrameLayout implements NestedScrollingParent,
    ...
    public interface OnScrollChangeListener {
         ...
         */
        void onScrollChange(NestedScrollViewCopy v, int scrollX, int scrollY,
    ...
    public NestedScrollViewCopy(Context context) {
        this(context, null);
    }

    public NestedScrollViewCopy(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NestedScrollViewCopy(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        //如果是惯性滑动，则调用惯性滑动的监听
        if (mIsFling) {
            mOnFlingListener.onScrollChange(t);
        }
    }
    ...
    public void smoothScrollTo(int x, int y, boolean isFling) {
        mIsFling = isFling;
        smoothScrollTo(x, y);
    }
    ...
    public interface OnFlingListener {
        void onScrollChange(int scrollYSize);
    }
    ...
    static class AccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        public boolean performAccessibilityAction(View host, int action, Bundle arguments) {
            ...
            final NestedScrollViewCopy nsvHost = (NestedScrollViewCopy) host;
