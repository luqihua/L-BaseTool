 ...
 */
public class DownRefreshBehavior extends CoordinatorLayout.Behavior<View> {
    ...
    public DownRefreshBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
